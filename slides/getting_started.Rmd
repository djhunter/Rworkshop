...
**$\Rightarrow$** Load the `mtcars` data set. Type `?mtcars` in the console to see a description of this data set. Create a new RMarkdown file in which you calculate a `summary` of this data, and `plot` a scatterplot of two of the variables. Include in your RMarkdown file a description of what the scatter plot tells you. When your report is finished, *Knit* it to HTML. Then copy and paste the HTML output into an email and send it to yourself.
